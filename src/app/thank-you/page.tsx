...
const ThankYouPage: FC<IPageProps> = async ({ searchParams }) => {
  ...
  const ordersTotal = products.reduce((total, { price }) => total + price, 0);
            ...
            <div className="mt-16 text-sm font-medium">
              ...
              <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
                <div className="flex justify-between">
                  <p>Subtotal</p>
                  <p className="text-gray-900">{formatPrice(ordersTotal)}</p>
                </div>
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900">
                  ...
                  <p className="text-base">{formatPrice(ordersTotal + 1)}</p>
                </div>
              </div>
